...
import { Button, Col, Empty, Flex, notification, Row, Table } from "antd";
...
export default function ArchiveVisitationTable(props) {
                                ...
                                locale={{
                                    emptyText: (
                                        <Empty
                                            ...
                                            description="No archived schedules found"
                                        />
                                    ),
                                }}
                            >
